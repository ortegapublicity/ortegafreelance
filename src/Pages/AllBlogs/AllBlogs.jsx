...
const AllBlogs = () => {
      ...
      try {
        const { posts: fetchedPosts, error: fetchError } =
          await loadContentfulPosts({
            include: 2,
            // puedes poner limit si quieres: limit: 6,
          });
  ...
  return (
    <>
      {/* Restaura el scroll al cambiar de ruta (mobile y desktop) */}
      <ScrollRestoration />
        ...
        <div className="container">
          ...
          >
            ...
            <p className="allblogs__intro">
              Explore the latest blog entries with useful recommendations,
              creative processes, and tactics that are already helping other
              brands grow. Select an article to dive deeper into the details.
            </p>
          </header>
